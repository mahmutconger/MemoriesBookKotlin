...
fun  myBrush() : Brush {
    ...
    val startColor by infiniteTransition.animateColor(
        ...
        animationSpec = infiniteRepeatable(animation = tween(4000), repeatMode = RepeatMode.Reverse), label = ""
    )
...
@Composable
fun myText(text: String, fontSize: Int, fontWeight: FontWeight, color: Color = Color.Black) {
    Text(
        text = text,
